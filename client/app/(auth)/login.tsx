...
// // // import { ArrowRight, Sun, Moon } from 'lucide-react-native';
// // // import Svg, { Path } from 'react-native-svg';
// // // import api from '../../services/api'; // Using your existing api setup
...
// // --- INTERNAL COMPONENTS MOVED OUTSIDE TO PREVENT RE-RENDER FOCUS GLITCH ---
...
//       // Since your controller searches by email, use the identifier you registered with
...
//                 <>
//                   <View style={styles.inputWrapper}>
//                     <Animated.Text style={[styles.inputLabel, { color: subColor }]}>EMAIL ID / PHONE</Animated.Text>
//                     <View style={[styles.githubInput, { backgroundColor: t.inputBg, borderColor: getInputBorderColor('email') }]}>
//                       <TextInput
//                         value={email}
//                         onChangeText={setEmail}
...
// --- HELPER COMPONENTS (Defined outside to prevent focus glitch) ---
          ...
          <ScrollView contentContainerStyle={styles.content} bounces={false} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formContainer}>
              {!isOtpSent ? (
                <>
                  <View style={styles.inputWrapper}>
                    <Animated.Text style={[styles.inputLabel, { color: subColor }]}>EMAIL ID OR NUMBER</Animated.Text>
                    <View style={[styles.githubInput, { backgroundColor: t.inputBg, borderColor: getInputBorderColor('email') }]}>
                      <TextInput
                        value={email}
                        onChangeText={setEmail}
                        placeholder="email@example.com || 9XXXXXX"
                        placeholderTextColor={isDark ? "#484F58" : "#C7C7CC"}
                        style={[styles.textInput, { color: t.text }]}
                        keyboardType="email-address"
                        autoCapitalize="none"
